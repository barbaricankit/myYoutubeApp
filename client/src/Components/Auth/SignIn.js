...
const SignIn = () => {
  ...
  const [
    { username, password, showPassword, incorrectPassword },
    loginDispatch,
  ] = useReducer(manageLoginReducer, initialState)
  ...
  return (
    <div className="signin-form">
      ...
      <div>
        ...
        <div>
          <input
            ...
            value={username}
            onChange={(e) =>
              loginDispatch({ type: 'UPDATE_USERNAME', value: e.target.value })
            }
          />
        </div>
        <br />
        ...
        <div className="password-textbox">
          <input
            ...
            value={password}
            onChange={(e) =>
              loginDispatch({ type: 'UPDATE_PASSWORD', value: e.target.value })
            }
          />
          {incorrectPassword && (
          ...
          <span
            ...
            onClick={() => loginDispatch({ type: 'UPDATE_SHOW_PASSWORD' })}
          >
      ...
      <button
        className="btn-primary btn-bg-color"
        onClick={() =>
          loginHandler({ username: 'ankit1234', password: 'Pwcwelcome' })
        }
      >
        Guest Login
      </button>
